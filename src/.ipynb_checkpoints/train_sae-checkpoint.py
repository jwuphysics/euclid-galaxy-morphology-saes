...
class EmbeddingDataset(Dataset):
    """Dataset for loading numpy embeddings"""
...
def train_epoch(model: KSparseAutoencoder,
               loader: DataLoader,
...
def main():
    ...
    parser.add_argument('--auxk_coef', type=float, default=0.03)
    parser.add_argument('--multik_coef', type=float, default=0.03)
