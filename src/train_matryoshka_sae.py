...
def main():
    ...
    parser.add_argument("--config", type=str, default="src/config/matryoshka_sae_config.toml",
                       help="Path to configuration file (default: src/config/matryoshka_sae_config.toml)")
    ...
    train_loader, test_loader = get_supervised_dataloaders(config)
